...
exposure-card-found-the-following-data = { -brand-monitor } 找到下列公開的資料:
exposure-card-exposure-type-data-broker = 資訊被出售
exposure-card-exposure-type-data-breach = 資料外洩事件
exposure-card-resolve-exposures-cta = 處理暴露事件
...
exposure-card-manual-resolution-praise = <b>做得好</b>您處理了這筆暴露事件。
