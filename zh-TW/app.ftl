...
what-is-data-agg-blurb = 資料收集器或資料中間商會從公開紀錄或其他來源收集資訊包含從公司購買的資料。他們整合這些資訊來建立詳細的消費者檔案再賣給企業做行銷用途。駭客可使用此資料進行檢測、偽裝或進行其他詐騙。您可能不認識這些公司因為資料收集器常常會在使用者註冊或服務未註冊的情況下收集個人資料。
