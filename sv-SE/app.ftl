...
mobile-menu-label = Huvudmenyn
main-nav-button-collapse-label = Komprimera meny
main-nav-button-collapse-tooltip = Komprimera meny
main-nav-button-expand-label = Expandera menyn
main-nav-button-expand-tooltip = Expandera menyn
...
user-menu-trigger-label = Öppna användarmenyn
