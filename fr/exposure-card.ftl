...
exposure-card-found-the-following-data = { -brand-monitor } a trouvé les données exposées suivantes :
...
exposure-card-manual-resolution-praise = <b>Beau travail !</b> Vous avez résolu ce problème.
