...
what-is-data-agg-blurb = Les agrégateurs de données, ou courtiers en données, collectent des informations à partir de dossiers publics et d’autres sources, y compris les données achetées aux entreprises. Ces informations servent à créer des profils de consommateurs détaillés, qui sont vendus aux entreprises à des fins publicitaires. Les pirates pourraient utiliser ces données pour le profilage, l’usurpation d’identité ou d’autres formes de fraude. Vous ne reconnaissez peut-être pas certaines de ces entreprises, car les agrégateurs de données collectent souvent des informations sur les personnes sans qu’elles aient jamais créé de compte ou signé à un service.
