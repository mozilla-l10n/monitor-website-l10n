...
security-recommendation-phone-summary =
    { $num_breaches ->
        [zero] Amlygwyd eich rhif ffôn mewn { $num_breakes } toriad data:
        [one] Datgelwyd eich rhif ffôn mewn { $num_breaches } toriad data:
        [two] Amlygwyd eich rhif ffôn mewn { $num_breakes } toriad data:
        [few] Amlygwyd eich rhif ffôn mewn { $num_breakes } toriad data:
        [many] Amlygwyd eich rhif ffôn mewn { $num_breakes } toriad data:
       *[other] Amlygwyd eich rhif ffôn mewn { $num_breakes } toriad data:
    }
...
security-recommendation-ip-summary =
    { $num_breaches ->
        [zero] Amlygwyd eich cyfeiriad IP mewn { $num_breakes } toriad data:
        [one] Datgelwyd eich cyfeiriad IP mewn { $num_breaches } toriad data:
        [two] Amlygwyd eich cyfeiriad IP mewn { $num_breakes } toriad data:
        [few] Amlygwyd eich cyfeiriad IP mewn { $num_breakes } toriad data:
        [many] Amlygwyd eich cyfeiriad IP mewn { $num_breakes } toriad data:
       *[other] Amlygwyd eich cyfeiriad IP mewn { $num_breakes } toriad data:
    }
...
leaked-passwords-title = Datgelwyd eich cyfrinair { $break_name }
# Variables
# $breach_date is the date when the breach occurred.
...
# $breach_date is the date when the breach occurred.
# An example of this string is Twitter on 13/09/18.
leaked-security-questions-summary = Roeddent yn ymddangos mewn toriad data ar { $breach_name } ar { $break_date }.
