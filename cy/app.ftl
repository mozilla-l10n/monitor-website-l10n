...
what-is-data-agg = Beth yw casglwr data?
what-is-data-agg-blurb = Mae cydgrynwyr data, neu froceriaid data, yn casglu gwybodaeth o gofnodion cyhoeddus a ffynonellau eraill, gan gynnwys data a brynwyd gan gwmnïau. Maent yn casglu'r wybodaeth hon i greu proffiliau defnyddwyr manwl, sy'n cael eu gwerthu i fusnesau at ddibenion marchnata. Gallai hacwyr ddefnyddio'r data hwn ar gyfer proffilio, dynwared, neu fathau eraill o dwyll. Efallai nad ydych yn adnabod rhai o'r cwmnïau hyn oherwydd bod cydgrynwyr data yn aml yn casglu gwybodaeth am bobl heb iddynt byth greu cyfrif neu gofrestru ar gyfer gwasanaeth.
