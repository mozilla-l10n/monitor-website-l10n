...
cryptocurrency-wallet-addresses = Διευθύνσεις πορτοφολιού κρυπτονομισμάτων
...
partial-government-issued-ids = Μερικές ταυτότητες που έχουν εκδοθεί από το δημόσιο
...
shipment-tracking-numbers = Αριθμοί καταγραφής αποστολής
