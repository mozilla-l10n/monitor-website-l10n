...
what-is-data-agg-blurb = Οι συναθροιστές δεδομένων, ή data brokers, συλλέγουν πληροφορίες από δημόσιες εγγραφές και άλλες πηγές, συμπεριλαμβανομένων δεδομένων που αγοράζονται από εταιρείες. Συγκεντρώνουν αυτές τις πληροφορίες για να δημιουργήσουν λεπτομερή προφίλ καταναλωτών, τα οποία πωλούνται σε επιχειρήσεις για σκοπούς μάρκετινγκ. Οι χάκερ θα μπορούσαν να χρησιμοποιήσουν αυτά τα δεδομένα για δημιουργία προφίλ, πλαστοπροσωπία ή άλλες μορφές απάτης. Μερικές από αυτές τις εταιρείες ενδέχεται να μην τις αναγνωρίζετε, επειδή οι μηχανές συγκέντρωσης δεδομένων συχνά συλλέγουν πληροφορίες σχετικά με άτομα χωρίς να έχουν δημιουργήσει λογαριασμό ή να έχουν εγγραφεί για κάποια υπηρεσία.
