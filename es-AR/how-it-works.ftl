...
how-it-works-page-data-breaches-step-1-text = Usando solo tu dirección de correo electrónico, te buscamos en todas las filtraciones de datos conocidas. Todos los suscriptores pueden monitorear 5 direcciones de correo electrónico de forma gratuita.
...
how-it-works-page-data-breaches-step-3-subtitle = Monitoreamos nuevas filtraciones
how-it-works-page-data-breaches-step-3-text = Cada vez que detectemos una nueva filtración, verificaremos si fuiste parte de ella y te avisaremos si lo fuiste.

## CTA button

how-it-works-page-data-breaches-cta-button = Hacé un escaneo gratuito

## FooterSection

how-it-works-page-footersection-title = Recuperá el control de tus datos
how-it-works-page-footersection-input-placeholder = example@example.com
how-it-works-page-footersection-cta-button = Hacé un escaneo gratuito
