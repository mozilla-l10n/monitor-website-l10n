...
what-is-data-agg-blurb = Los agregadores de datos, o intermediarios de datos, recopilan información de registros públicos y otras fuentes, incluidos los datos comprados a las empresas. Recopilan esta información para crear perfiles detallados de los consumidores, que se venden a las empresas con fines de marketing. Los piratas informáticos podrían usar estos datos para la creación de perfiles, la suplantación de identidad u otras formas de fraude. Es posible que no reconozca algunas de estas empresas porque los agregadores de datos a menudo recopilan información sobre las personas sin que ellas mismas creen una cuenta o se registren en un servicio.
