...
email-breach-alert-all-hero-heading-1 = { $company-name } detalles de violación de datos
# $company-name is the name of the company/site that was breached.
# $breach-date is the date of the breach.
email-breach-alert-all-lead-1 = { -brand-mozilla-monitor } encontró tu información en una violación de datos de { $company-name } el { $breach-date }. Estás recibiendo esta alerta porque te registraste para recibir <link_to_settings>notificaciones de filtraciones</link_to_settings>.
...
email-breach-alert-all-next-steps-button-resolve-breach-on-dashboard = Resolver violación en el tablero
...
email-breach-alert-faq-ans-3 = Una notificación { -brand-mozilla-monitor } se envía cuando la información personal que estás monitoreando es expuesta, robada o copiada sin permiso.
email-breach-alert-faq-qn-4 = ¿Cuánto es { -brand-mozilla-monitor }?
email-breach-alert-faq-ans-4 = Un servicio gratuito de notificación de violaciones de datos que te advierte si tus cuentas en línea se han visto involucradas en una violación de datos.
