...
modal-fixed-number-of-exposures-title = Over uw aantal vaste opnamen
modal-fixed-number-of-exposures-all = Deze grafiek toont het totale aantal opgeloste datalekken voor alle e-mailadressen die u momenteel in de gaten houdt. Zodra opnamen als vast zijn gemarkeerd, worden ze hier aan het totaal toegevoegd.
modal-cta-ok = OK
...
dashboard-top-banner-protect-your-data-cta = Laten we het repareren
