...
settings-delete-monitor-plus-account-dialog-lead-p1 = Al uw { -brand-monitor }-accountgegevens worden verwijderd en we controleren niet meer op nieuwe datalekken of blootstellingen van de databrokers. Dit zal uw { -brand-mozilla }-account niet verwijderen.
settings-delete-monitor-plus-account-dialog-lead-p2 = Uw betaalde abonnement eindigt vandaag en de rest van uw abonnement wordt niet naar rato uitgevoerd.
