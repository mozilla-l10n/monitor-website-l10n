...
email-breach-alert-all-hero-heading-1 = { $company-name } details over datalekken
# $company-name is the name of the company/site that was breached.
# $breach-date is the date of the breach.
email-breach-alert-all-lead-1 = { -brand-mozilla-monitor } heeft uw gegevens gevonden in een { $company-name } datalek op { $breach-date }. U krijgt deze melding omdat u zich hebt aangemeld voor <link_to_settings>meldingen van datalekken</link_to_settings>.
...
email-breach-alert-faq-ans-1 = U hebt zich ingeschreven voor waarschuwingen over datalekken. <link_to_settings>Werk uw voorkeuren bij</link_to_settings> op elk gewenst moment in uw instellingen.
...
email-breach-alert-faq-ans-3 = Een melding { -brand-mozilla-monitor } verstuurt wanneer persoonlijke gegevens die u bewaakt zonder toestemming worden gelekt, gestolen of gekopieerd.
