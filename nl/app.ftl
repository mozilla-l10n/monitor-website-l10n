...
what-is-data-agg-blurb = Gegevensverzamelaars of gegevensmakelaars verzamelen gegevens uit openbare registers en andere bronnen, waaronder gegevens die van bedrijven zijn gekocht. Ze verzamelen deze informatie om gedetailleerde consumentenprofielen te maken, die voor marketingdoeleinden aan bedrijven worden verkocht. Hackers kunnen deze gegevens gebruiken voor profilering, nabootsing van identiteit of andere vormen van fraude. Misschien herkent u sommige van deze bedrijven niet, omdat gegevensverzamelaars vaak gegevens over mensen verzamelen zonder dat ze ooit een account aanmaken of zich voor een dienst hebben ingeschreven.
