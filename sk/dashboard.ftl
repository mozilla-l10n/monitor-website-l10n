...
exposure-chart-heading =
    { $nr ->
        [one] <nr>{ $nr }</nr><label>zverejnenie</label>
        [few] <nr>{ $nr }</nr><label>zverejnenia</label>
        [many] <nr>{ $nr }</nr><label>zverejnení</label>
       *[other] <nr>{ $nr }</nr><label>zverejnení</label>
    }
# Variables:
#   $nr (number) - Number of fixed exposures found for the user
exposure-chart-heading-fixed = <nr>{ $nr }</nr> <label>opravených</label>
exposure-chart-legend-heading-type = Zverejnenie
...
exposure-chart-caption-fixed = Tento graf zobrazuje celkový zverejnení, ktoré sú opravené ({ $total_fixed_exposures_num } z { $total_exposures_num })
...
modal-active-number-of-exposures-title = O vašom počte aktívnych zverejnení
modal-cta-ok = OK
...
dashboard-exposures-area-description-all-line1 =
    { $exposures_unresolved_num ->
        [one] Našli sme { $exposures_unresolved_num } zverejnenie vašich údajov.
        [few] Našli sme { $exposures_unresolved_num } zverejnenia vašich údajov.
        [many] Našli sme { $exposures_unresolved_num } zverejnení vašich údajov.
       *[other] Našli sme { $exposures_unresolved_num } zverejnení vašich údajov.
    }
...
dashboard-top-banner-no-exposures-found-title = Neboli nájdené žiadne zverejnenia
dashboard-no-exposures-label = Neboli nájdené žiadne zverejnenia
