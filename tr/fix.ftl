...
high-risk-breach-social-security-step-one = <link_to_info>Dolandırıcılık uyarısını açarak veya kredinizi dondurarak</link_to_info> kendinizi koruyun.</link_to_info>
...
ssn-modal-description-freeze-credit-part-two = Kredinizi dondurmak için üç kredi ofisinden biriyle iletişime geçin: <quifax_link>Equifax</quifax_link>, <experian_link>Experian</experian_link> ve <transunion_link>TransUnion</transunion_link>.
