...
email-breach-alert-all-hero-heading-1 = { $company-name } подробностей об утечке данных
# $company-name is the name of the company/site that was breached.
# $breach-date is the date of the breach.
email-breach-alert-all-lead-1 = { -brand-mozilla-monitor } обнаружил вашу информацию в { $company-name } утечке данных на { $breach-date }. Вы получили это уведомление, потому что вы подписались на <link_to_settings>уведомления об утечках</link_to_settings>.
...
email-breach-alert-next-steps-description = <sign_in_link>Войдите</sign_in_link> на панель управления { -brand-mozilla-monitor }. Мы проведем вас через шаги, необходимые для её решения.
email-breach-alert-all-next-steps-button-resolve-breach-on-dashboard = Разобраться с утечкой на панели
email-breach-alert-faqs-title = ЧЗВ
email-breach-alert-faq-qn-1 = Почему я это получаю?
email-breach-alert-faq-ans-1 = Вы подписались на уведомления об утечках данных. <link_to_settings>Обновляйте свои настройки</link_to_settings> в любое время в настройках.
email-breach-alert-faq-qn-2 = Почему я не узнаю эту компанию или сайт?
email-breach-alert-faq-ans-2 = Оно могло изменить владельца или имя, затрагивать старую учётную запись или учётную запись, созданную для вас, или произойти от купленного списка раскрытой личной информации.
email-breach-alert-faq-qn-3 = Что такое уведомление об утечке данных?
email-breach-alert-faq-ans-3 = Уведомление { -brand-mozilla-monitor } отправляется, когда личная информация, за которой вы отслеживаете, будет раскрыта, украдена или скопирована без разрешения.
email-breach-alert-faq-qn-4 = Что такое { -brand-mozilla-monitor }?
email-breach-alert-faq-ans-4 = Бесплатная служба уведомления об утечке данных, которая предупреждает, если ваши аккаунты были затронуты утечкой данных.
