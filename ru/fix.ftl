...
guided-resolution-flow-exit = Вернуться на панель
...
fix-flow-celebration-high-risk-title = Вы исправили свои воздействия с высоким риском!
fix-flow-celebration-high-risk-description-in-progress = Выполнение этой работы может показаться чем-то большим, но важно делать это, чтобы обеспечить свою безопасность. Продолжайте в том же духе.
fix-flow-celebration-high-risk-description-done = Выполнение этой работы может показаться чем-то большим, но важно делать это, чтобы обеспечить свою безопасность.
...
fix-flow-celebration-high-risk-description-next-dashboard = Вы достигли конца ваших шагов. Вы можете просмотреть любые действия и отслеживать свой прогресс на панели управления.
...
fix-flow-celebration-leaked-passwords-description-next-security-questions = Теперь давайте проверим и обновим обнаруженные вами контрольные вопросы.
...
fix-flow-celebration-leaked-passwords-description-next-dashboard = Отлично сделано! Вы достигли конца ваших шагов. Вы можете просмотреть любые действия и отслеживать свой прогресс на панели управления.

## Security recommendations flow

fix-flow-celebration-security-recommendations-title = Вы выполнили все свои рекомендации!
fix-flow-celebration-security-recommendations-description-next-dashboard = Отлично сделано! Вы достигли конца ваших шагов. Вы можете просмотреть любые действия и отслеживать свой прогресс на панели управления.
...
high-risk-breach-summary =
    { $num_breaches ->
        ...
        [few] Он был затронут { $num_breaches } утечками данных:
       *[many] Он был затронут { $num_breaches } утечками данных:
    }
# Variables
...
high-risk-breach-mark-as-fixed = Отметить как зафиксированный
...
high-risk-breach-estimated-time =
    { $estimated_time ->
        [one] Ваше расчетное время: { $estimated_time }+ минут
        [few] Ваше расчетное время: { $estimated_time }+ минут
...
high-risk-breach-credit-card-step-one = Если у вас всё ещё есть эта карта, свяжитесь с издателем и сообщите о ней.
high-risk-breach-credit-card-step-two = Запросить новую карту с новым номером.
high-risk-breach-credit-card-step-three = Проверьте свои аккаунты на наличие несанкционированных списаний.
...
high-risk-breach-bank-account-step-three = Проверьте свои аккаунты на наличие несанкционированных списаний.

# Social Security Number Breaches

high-risk-breach-social-security-title = Ваш номер социального страхования был раскрыт
high-risk-breach-social-security-description = Мошенники могут открыть новые кредиты или кредитные карты с вашим номером социального страхования. Действуйте быстро, чтобы предотвратить финансовые потери.
...
high-risk-breach-social-security-step-two = <link_to_info>Проверьте свой кредитный отчёт</link_to_info> на наличие нераспознанных аккаунтов.
...
ssn-modal-description-fraud-part-two = Чтобы его создать, свяжитесь с любым из трёх кредитных бюро. Вам не обязательно связываться со всеми трём.
...
ssn-modal-description-freeze-credit-part-two = Чтобы заморозить свой кредит, обратитесь в каждое из трёх кредитных советов — <equifax_link>Equifax</equifax_link>, <experian_link>Experian</experian_link> и <transunion_link>TransUnion</transunion_link>.
...
high-risk-breach-pin-step-three = Проверьте свои аккаунты на наличие несанкционированных списаний.
...
security-recommendation-phone-summary =
    { $num_breaches ->
        [one] Ваш номер телефона был затронут { $num_breaches } утечками данных:
        [few] Ваш номер телефона был затронут { $num_breaches } утечками данных:
       *[many] Ваш номер телефона был затронут { $num_breaches } утечками данных:
    }
security-recommendation-phone-description = К сожалению, вы не можете забрать это обратно. Но есть шаги, которые вы можете предпринять, чтобы убедиться, что вы находитесь в безопасности.
security-recommendation-phone-step-one = Блокируйте номера для спама, чтобы предотвратить больше нежелательных звонков
...
security-recommendation-email-summary =
    { $num_breaches ->
        [one] Ваш адрес электронной почты был затронут { $num_breaches } утечками данных:
        [few] Ваш адрес электронной почты был затронут { $num_breaches } утечками данных:
       *[many] Ваш адрес электронной почты был затронут { $num_breaches } утечками данных:
    }
...
security-recommendation-email-step-one = не переходить по ссылкам в электронных письмах от неизвестных отправителей; если кажется, что это из доверенного источника, позвоните напрямую для подтверждения
security-recommendation-email-step-two = Помните о <link_to_info>фишинге</link_to_info>
security-recommendation-email-step-three = Отмечать подозрительные письма как спам и блокировать отправителя
...
security-recommendation-ip-summary =
    { $num_breaches ->
        [one] Ваш IP-адрес был затронут { $num_breaches } утечками данных:
        [few] Ваш IP-адрес был затронут { $num_breaches } утечками данных:
       *[many] Ваш IP-адрес был затронут { $num_breaches } утечками данных:
    }
...
# Variables
# $breach_date is the date when the breach occurred.
leaked-passwords-summary = Он затронут утечкой данных { $breach_date }.
...
leaked-passwords-step-two = Измените его в любом другом месте, где вы его использовали.
leaked-passwords-mark-as-fixed = Отметить как зафиксированный
...
leaked-passwords-estimated-time =
    { $estimated_time ->
        [one] Расчётное. время выполнения: { $estimated_time } минут на сайт
        [few] Расчётное. время выполнения: { $estimated_time } минут на сайт
...
# $breach_date is the date when the breach occurred.
# An example of this string is Twitter on 13/09/18.
leaked-security-questions-summary = Они затронуты утечкой данных { $breach_name } { $breach_date }.
...
leaked-security-questions-step-two = Обновите их на любом сайте, где вы использовали те же контрольные вопросы. Обязательно используйте разные контрольные вопросы для разных учётных записей.
