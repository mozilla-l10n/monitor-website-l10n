...
dashboard-top-banner-non-us-protect-your-data-description-line2 =
    { $data_breach_unresolved_num ->
        [one] Он обнаружен в { $data_breach_unresolved_num } утечке данных. Мы пошагово поможем вам, как это исправить.
        [few] Он был обнаружен в { $data_breach_unresolved_num } утечках данных. Мы пошагово поможем вам, как это исправить.
       *[many] Он был обнаружен в { $data_breach_unresolved_num } утечках данных. Мы пошагово поможем вам, как это исправить.
    }
...
modal-exposure-status-title = О статусах раскрытия
modal-exposure-status-description-all = Мы ищем утечки данных во всех известных утечках данных. Ваши снимки будут иметь один из следующих статусов:
modal-exposure-status-action-needed = <b>Требуется действие</b> означает, что оно в данный момент активно и вам нужно предпринять шаги для его исправления.
modal-exposure-status-fixed = <b>Исправлено</b> означает, что контакт был решён и с вас не нужно предпринимать никаких действий.
