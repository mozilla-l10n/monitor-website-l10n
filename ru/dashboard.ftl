...
dashboard-top-banner-non-us-your-data-is-protected-description =
    { $exposures_resolved_num ->
        ...
        [few] Отличная работа, все { $expositions_resolved_num } утечки ваших данных устранены! Мы продолжим отслеживать и предупредим вас о любых новых утечках.
       *[many] Отличная работа, все { $expositions_resolved_num } утечек ваших данных устранены! Мы продолжим отслеживать и предупредим вас о любых новых утечках.
    }
