...
-brand-fxa = „Firefox“ paskyra
-brand-Chrome = „Chrome“
layout-Firefox = { -brand-name }
# Descriptive headline for a column of links where users can give feedback, or get additional information about, Firefox Monitor.
layout-support = Palaikymas
# Link that takes the user to a blog post on blog.mozilla.org about the alerts
about-firefox-alerts = Apie „Firefox“ pranešimus
# Link that takes the user to a Firefox Monitor survey. 
give-feedback = Palikti atsiliepimą
terms-and-privacy = Sąlygos ir privatumas
error-could-not-add-email = Nepavyko pridėti el. pašto adreso į duomenų bazę.
...
hibp-notify-email-subject = „{ -product-name }“ perspėjimas: jūsų paskyra pateko į pažeidimą.
home-title = { -product-name }
home-not-found = Tinklalapis nerastas.
oauth-invalid-session = Blogas seansas
oauth-confirmed-title = „{ -product-name }“ : prenumeruojama
...
user-add-title = „{ -product-name }“ : patvirtinkite el. paštą
...
pwt-headline-2 = Sukurkite stiprius, sunkiai atspėjamus slaptažodžius.
