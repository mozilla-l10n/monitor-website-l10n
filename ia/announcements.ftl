...
announcement-free-data-breach-monitoring-title =
    { $emailAddressesCount ->
        [one] Survelia gratuitemente le violationes de datos pro un maximo de { NUMBER($emailAddressesCount) } adresse e-mail.
       *[other] Survelia gratuitemente le violationes de datos pro un maximo de { NUMBER($emailAddressesCount) } adresses e-mail.
    }
